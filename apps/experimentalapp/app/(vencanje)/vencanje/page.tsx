  ...
  return (
    <div className={'px-8 py-0'}>
      <section className='min-h-screen flex-1 flex flex-col justify-center items-center  px-0 py-16 fadeIn'>
        ...
        <h1 className='naslov z-10 text-9xl text-[#30291b] capitalize font-extralight '>sunčica i luka</h1>
        <p className='naslov z-10 pt-5'>Vas pozivaju da prisustvujete našem venčanju<br/></p>
        <h1 className='naslov2 uppercase z-10 text-[#c59536]'>14:30 Subota, 6. Jul, 2024</h1>
        ...
        <Image className='pt-10 z-10' src={'/bouquet.png'} alt='bouquet' width={300} height={245}/>
      </section>
    </div>
  )
}
