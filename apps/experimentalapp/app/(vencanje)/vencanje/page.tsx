  ...
  return (
    <div className={'px-8 py-0'}>
      <section className='min-h-screen flex-1 flex flex-col justify-center items-center  px-0 py-16 fadeIn'>
        ...
        <h1 className='naslov z-10 text-7xl text-[#30291b] capitalize font-extrabold italic'>suncica i luka</h1>
        <p className='naslov z-10 pt-5'>Vas pozivaju da prisustvujete nasem vencanju<br/></p>
